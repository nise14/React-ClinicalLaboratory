...
export function Sidebar({ open, setOpen }: SidebarProps) {
    ...
    const configuRationClick = (label: string) => {
        if (label === "Settings") {
                ...
                <ul className="menu">
                    {menuItems.map((menu, index) => (
                        <li key={index} className="decoration">
                            <NavLink to={menu.path} className={`menuItems ${menu.spacing ? "spacingLg" :
                                "spacingMd"}`} title={menu.label} 
                                onClick={() => configuRationClick(menu.label)}>
